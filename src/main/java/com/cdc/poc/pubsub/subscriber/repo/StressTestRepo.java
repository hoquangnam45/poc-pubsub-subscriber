...
public interface StressTestRepo {
    void updateTopicResult(@Param("testId") UUID testId, @Param("messageId") UUID messageId, @Param("topicArrivalTime") Instant topicArrivalTime, @Param("topicPublishTime") Instant topicPublishTime);
